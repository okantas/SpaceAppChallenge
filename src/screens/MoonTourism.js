...
const MoonTourism = () => {
  ...
  const journeys = [
    {
      ...
      goTo: () => navigation.navigate("MoonToEarth"),
    },
    {
      title: "TO SATURN",
      images: [
      ...
      goTo: () => navigation.navigate("MoonToSaturn"),
    },
    {
      title: "TO MARS",
      images: [
      ...
      goTo: () => navigation.navigate("MoonToMars"),
    },
    {
      title: "TO URANUS",
      images: [
      ...
      goTo: () => navigation.navigate("MoonToUranus"),
    },
    {
      title: "TO VENUS",
      images: [
      ...
      goTo: () => navigation.navigate("MoonToVenus"),
    },
    {
      title: "TO NEPTUNE",
      images: [
      ...
      goTo: () => navigation.navigate("MoonToNeptune"),
    },
  ];
  ...
  return (
    ...
    >
      <Text style={styles.title}>WELCOME TO MOON TOURISM</Text>
