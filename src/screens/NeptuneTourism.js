...
const NeptuneTourism = () => {
  ...
  const journeys = [
    {
      ...
      goTo: () => navigation.navigate("NeptuneToEarth"),
    },
    {
      title: "TO MOON",
      images: [
      ...
      goTo: () => navigation.navigate("NeptuneToMoon"),
    },
    {
      title: "TO SATURN",
      images: [
      ...
      goTo: () => navigation.navigate("NeptuneToSaturn"),
    },
    {
      title: "TO MARS",
      images: [
      ...
      goTo: () => navigation.navigate("NeptuneToMars"),
    },
    {
      title: "TO URANUS",
      images: [
      ...
      goTo: () => navigation.navigate("NeptuneToUranus"),
    },
    {
      title: "TO VENUS",
      images: [
      ...
      goTo: () => navigation.navigate("NeptuneToVenus"),
    },
  ];
  ...
  return (
    ...
    >
      <Text style={styles.title}>WELCOME TO NEPTUNE TOURISM</Text>
