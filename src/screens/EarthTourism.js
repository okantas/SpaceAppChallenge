...
const EarthTourism = () => {
  ...
  const journeys = [
    {
      ...
      goTo: () => navigation.navigate("EarthToMoon"),
    },
    {
      title: "TO SATURN",
      images: [
      ...
      goTo: () => navigation.navigate("EarthToSaturn"),
    },
    {
      title: "TO MARS",
      images: [
      ...
      goTo: () => navigation.navigate("EarthToMars"),
    },
    {
      title: "TO URANUS",
      images: [
      ...
      goTo: () => navigation.navigate("EarthToUranus"),
    },
    {
      title: "TO VENUS",
      images: [
      ...
      goTo: () => navigation.navigate("EarthToVenus"),
    },
    {
      title: "TO NEPTUNE",
      images: [
      ...
      goTo: () => navigation.navigate("EarthToNeptune"),
    },
  ];
  ...
  return (
    ...
    >
      <Text style={styles.title}>WELCOME TO EARTH TOURISM</Text>
