...
const UranusTourism = () => {
  ...
  const journeys = [
    {
      ...
      goTo: () => navigation.navigate("UranusToEarth"),
    },
    {
      title: "TO MOON",
      images: [
      ...
      goTo: () => navigation.navigate("UranusToVenus"),
    },
    {
      title: "TO SATURN",
      images: [
      ...
      goTo: () => navigation.navigate("UranusToSaturn"),
    },
    {
      title: "TO MARS",
      images: [
      ...
      goTo: () => navigation.navigate("UranusToMars"),
    },
    {
      title: "TO VENUS",
      images: [
    ...
    },
    {
      ...
      goTo: () => navigation.navigate("UranusToNeptune"),
    },
  ];
  ...
  return (
    ...
    >
      <Text style={styles.title}>WELCOME TO URANUS TOURISM</Text>
