...
const SaturnTourism = () => {
  ...
  const journeys = [
    {
      ...
      goTo: () => navigation.navigate("SaturnToEarth"),
    },
    {
      title: "TO MOON",
      images: [
      ...
      goTo: () => navigation.navigate("SaturnToMoon"),
    },
    {
      title: "TO MARS",
      images: [
      ...
      goTo: () => navigation.navigate("SaturnToMars"),
    },
    {
      title: "TO URANUS",
      images: [
      ...
      goTo: () => navigation.navigate("SaturnToUranus"),
    },
    {
      title: "TO VENUS",
      images: [
      ...
      goTo: () => navigation.navigate("SaturnToVenus"),
    },
    {
      title: "TO NEPTUNE",
      images: [
      ...
      goTo: () => navigation.navigate("SaturnToNeptune"),
    },
  ];
  ...
  return (
    ...
    >
      <Text style={styles.title}>WELCOME TO SATURN TOURISM</Text>
